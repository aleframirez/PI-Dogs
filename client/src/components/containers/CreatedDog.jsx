...
const validate = (form) => {
  ...
  if(!form.min_height || !form.max_height || form.min_height > form.max_height || form.max_height < form.min_height) error.height = "Required fields: Height min - max"
  if(!form.min_weight || !form.max_weight || form.min_weight > form.max_weight || form.max_weight < form.min_weight) error.weight = "Required fields: Weight min - max"
